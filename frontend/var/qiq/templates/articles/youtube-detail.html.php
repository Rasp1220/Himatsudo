...
<article style="max-width:780px;margin:0 auto">
    ...
    <?php elseif (!empty($article['youtube_thumbnail'])): ?>
    <a href="<?= $this->h($article['youtube_url'] ?? '#') ?>" target="_blank" rel="noopener noreferrer" style="display:block;margin-bottom:2rem">
        <img src="<?= $this->h($article['youtube_thumbnail']) ?>"
    ...
    <p style="margin-bottom:1.5rem">
        <a href="<?= $this->h($article['youtube_url']) ?>" target="_blank" rel="noopener noreferrer"
