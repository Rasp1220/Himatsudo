...
<div class="content-layout">
            ...
            <article class="card">
                <a href="{{ $articleUrl($article) }}">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge {{ $catType }}" style="display:inline-block;margin-bottom:.4rem">
    ...
    <aside class="content-aside sidebar">
        ...
        <ul>
            <li>
                <a href="/articles"{% if (empty($category_id) && empty($list_base_url) && empty($category_slug)) %} class="active"{% endif %}>すべて</a>
            </li>
            ...
            <li>
                <a href="{{ $catUrl }}"{% if ($isActive) %} class="active"{% endif %}>
                    {{ (string) $cat['name'] }}
                </a>
            </li>
            {% endforeach %}
