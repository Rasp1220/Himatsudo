...
final readonly class Article
{
    public function __construct(
        ...
        public ?string $relatedArticleIds,
    ...
    public static function fromArray(array $row): self
    {
        return new self(
            ...
            relatedArticleIds: isset($row['related_article_ids']) ? (string) $row['related_article_ids'] : null,
    ...
    public function toArray(): array
    {
        return [
            ...
            'related_article_ids' => $this->relatedArticleIds,
